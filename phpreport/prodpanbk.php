<?php
    ...
    $sqlventaslun = "SELECT prod.descripcion, sum(detalle.cantidad) AS Cantidad
                    ...
                    WHERE tick.cierre BETWEEN '".$fecha1." 12:00:00 AM' AND '".$fecha1." 11:59:59 PM' 
                                      AND tick.pagado = 1
                                            AND tick.cancelado =0
                                            AND (gpo.descripcion = 'PASTRIES'
                                            OR gpo.descripcion = 'ARTESIAN BREAD')
    ...
    $sqlventasmar = "SELECT prod.descripcion, sum(detalle.cantidad) AS Cantidad
                    FROM cheqdet detalle LEFT JOIN cheques tick ON detalle.foliodet = tick.folio LEFT JOIN productos prod ON detalle.idproducto = prod.idproducto RIGHT JOIN grupos gpo ON prod.idgrupo = gpo.idgrupo
                    WHERE tick.cierre BETWEEN '".$fecha2." 12:00:00 AM' AND '".$fecha2." 11:59:59 PM' 
                                      AND tick.pagado = 1
                                            AND tick.cancelado =0
                                            AND (gpo.descripcion = 'PASTRIES'
                                            OR gpo.descripcion = 'ARTESIAN BREAD')
    ...
    $sqlventasmie = "SELECT prod.descripcion, sum(detalle.cantidad) AS Cantidad
                    FROM cheqdet detalle LEFT JOIN cheques tick ON detalle.foliodet = tick.folio LEFT JOIN productos prod ON detalle.idproducto = prod.idproducto RIGHT JOIN grupos gpo ON prod.idgrupo = gpo.idgrupo
                    WHERE tick.cierre BETWEEN '".$fecha3." 12:00:00 AM' AND '".$fecha3." 11:59:59 PM' 
                                      AND tick.pagado = 1
                                            AND tick.cancelado =0
                                            AND (gpo.descripcion = 'PASTRIES'
                                            OR gpo.descripcion = 'ARTESIAN BREAD')
    ...
    $sqlventasjue = "SELECT prod.descripcion, sum(detalle.cantidad) AS Cantidad
                    FROM cheqdet detalle LEFT JOIN cheques tick ON detalle.foliodet = tick.folio LEFT JOIN productos prod ON detalle.idproducto = prod.idproducto RIGHT JOIN grupos gpo ON prod.idgrupo = gpo.idgrupo
                    WHERE tick.cierre BETWEEN '".$fecha4." 12:00:00 AM' AND '".$fecha4." 11:59:59 PM' 
                                      AND tick.pagado = 1
                                            AND tick.cancelado =0
                                            AND (gpo.descripcion = 'PASTRIES'
                                            OR gpo.descripcion = 'ARTESIAN BREAD')
    ...
    $sqlventasvie = "SELECT prod.descripcion, sum(detalle.cantidad) AS Cantidad
                    FROM cheqdet detalle LEFT JOIN cheques tick ON detalle.foliodet = tick.folio LEFT JOIN productos prod ON detalle.idproducto = prod.idproducto RIGHT JOIN grupos gpo ON prod.idgrupo = gpo.idgrupo
                    WHERE tick.cierre BETWEEN '".$fecha5." 12:00:00 AM' AND '".$fecha5." 11:59:59 PM' 
                                      AND tick.pagado = 1
                                            AND tick.cancelado =0
                                            AND (gpo.descripcion = 'PASTRIES'
                                            OR gpo.descripcion = 'ARTESIAN BREAD')
    ...
    $sqlventassab = "SELECT prod.descripcion, sum(detalle.cantidad) AS Cantidad
                    FROM cheqdet detalle LEFT JOIN cheques tick ON detalle.foliodet = tick.folio LEFT JOIN productos prod ON detalle.idproducto = prod.idproducto RIGHT JOIN grupos gpo ON prod.idgrupo = gpo.idgrupo
                    WHERE tick.cierre BETWEEN '".$fecha6." 12:00:00 AM' AND '".$fecha6." 11:59:59 PM' 
                                      AND tick.pagado = 1
                                            AND tick.cancelado =0
                                            AND (gpo.descripcion = 'PASTRIES'
                                            OR gpo.descripcion = 'ARTESIAN BREAD')
    ...
    $sqlventasdom = "SELECT prod.descripcion, sum(detalle.cantidad) AS Cantidad
                    FROM cheqdet detalle LEFT JOIN cheques tick ON detalle.foliodet = tick.folio LEFT JOIN productos prod ON detalle.idproducto = prod.idproducto RIGHT JOIN grupos gpo ON prod.idgrupo = gpo.idgrupo
                    WHERE tick.cierre BETWEEN '".$fechafinal." 12:00:00 AM' AND '".$fechafinal." 11:59:59 PM' 
                                      AND tick.pagado = 1
                                            AND tick.cancelado =0
                                            AND (gpo.descripcion = 'PASTRIES'
                                            OR gpo.descripcion = 'ARTESIAN BREAD')
    ...
    $file = fopen("C:\Users\Josue\Downloads\panbk.txt", "w");
