<?php
    ...
    $sqldescuentos = "SELECT SUM(descuentoimporte) as TOTALDESCUENTO
                      FROM cheques
                      WHERE cierre BETWEEN '".$fechadr." 12:00:00 AM' AND '".$fechadr." 11:59:59 PM' AND descuento > 0";
	...
	if( $stmt === false ) {
    	echo "Error in executing statement0.\n";  
    ...
    /*echo $h."varible de costos";
    echo $i."varible de ventas";*/

    $c1 = $i;
    $c2 = $h;

    /*for($l=0; $l<$c1; $l++){
        $totalv = $totalv + $Importe[$l];
    }
    for($m=0; $m<$c2; $m++){
        $totalg = $totalg + $Importe1[$m];
    }*/

/*    echo $totalv."ES EL DE VENTAS"."=======".$totalg."es el de costo";*/
    ...
    $objPHPExcel->getProperties()->setCreator("MHBQA"); // Nombre del autor
    ...
    //$objPHPExcel->getActiveSheet()->SetCellValue('G27', $totalv);
    ...
    //$objPHPExcel->getActiveSheet()->SetCellValue('G38', $totalg);
    ...
    header('Content-Disposition: attachment;filename="BVG MHBQA'.$nf.'.xlsx"');
